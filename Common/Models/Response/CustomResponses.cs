...
public class BusinessConflictErrorResponse<T> : Common.Models.Response.ErrorResponse<T> where T : class
{
...
public class BadParametersErrorResponse<T> : Common.Models.Response.ErrorResponse<T> where T : class
{
...
public class NotFoundErrorResponse<T> : Common.Models.Response.ErrorResponse<T> where T : class
{
	public NotFoundErrorResponse(IEnumerable<Error> errors)
	{
		Code = ErrorCodes.Global.NotFound;
...
public class SecurityErrorResponse<T> : Common.Models.Response.ErrorResponse<T> where T : class
{
